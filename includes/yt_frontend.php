...
if (!function_exists('yt_frontend_registry')) {
    function yt_frontend_registry(): array
    {
        ...
        $imageFields = [
            ...
            'step1Image' => ['group' => 'Steps', 'label' => 'Step 1 Image', 'type' => 'image', 'render' => 'src', 'selector' => '.steps-section .step-item:nth-of-type(1) .step-image', 'attribute' => 'src'],
            'step2Image' => ['group' => 'Steps', 'label' => 'Step 2 Image', 'type' => 'image', 'render' => 'src', 'selector' => '.steps-section .step-item:nth-of-type(2) .step-image', 'attribute' => 'src'],
            'step3Image' => ['group' => 'Steps', 'label' => 'Step 3 Image', 'type' => 'image', 'render' => 'src', 'selector' => '.steps-section .step-item:nth-of-type(3) .step-image', 'attribute' => 'src'],
            'mp3PromoImage1' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 1', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(1) img', 'attribute' => 'src'],
            'mp3PromoImage2' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 2', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(2) img', 'attribute' => 'src'],
            'mp3PromoImage3' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 3', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(3) img', 'attribute' => 'src'],
            'mp3PromoImage4' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 4', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(4) img', 'attribute' => 'src'],
            'mp3PromoImage5' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 5', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(5) img', 'attribute' => 'src'],
        ];
        ...
        $homeFields = array_merge($navFields, $imageFields, [
            ...
            'heroSubtitle' => ['group' => 'Hero', 'label' => 'Hero Subtitle', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            ...
            'sectionTitle' => ['group' => 'Intro', 'label' => 'Intro Section Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            ...
            'feature1Title' => ['group' => 'Features', 'label' => 'Feature 1 Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature1Desc' => ['group' => 'Features', 'label' => 'Feature 1 Description', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature2Title' => ['group' => 'Features', 'label' => 'Feature 2 Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature2Desc' => ['group' => 'Features', 'label' => 'Feature 2 Description', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature3Title' => ['group' => 'Features', 'label' => 'Feature 3 Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature3Desc' => ['group' => 'Features', 'label' => 'Feature 3 Description', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature4Title' => ['group' => 'Features', 'label' => 'Feature 4 Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature4Desc' => ['group' => 'Features', 'label' => 'Feature 4 Description', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature5Title' => ['group' => 'Features', 'label' => 'Feature 5 Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature5Desc' => ['group' => 'Features', 'label' => 'Feature 5 Description', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature6Title' => ['group' => 'Features', 'label' => 'Feature 6 Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'feature6Desc' => ['group' => 'Features', 'label' => 'Feature 6 Description', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'mp3PromoTitle' => ['group' => 'MP3 Promo', 'label' => 'MP3 Promo Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'mp3PromoDesc' => ['group' => 'MP3 Promo', 'label' => 'MP3 Promo Description', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'stepsTitle' => ['group' => 'Steps', 'label' => 'Steps Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'step1' => ['group' => 'Steps', 'label' => 'Step 1', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'step2' => ['group' => 'Steps', 'label' => 'Step 2', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'step3' => ['group' => 'Steps', 'label' => 'Step 3', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
            'faqTitle' => ['group' => 'FAQ', 'label' => 'FAQ Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
        ...
        $homeDefaults = [
            ...
            'mp3PromoTitle' => 'Free Online YouTube to MP3 converter',
            'mp3PromoImage1' => '',
            'mp3PromoImage2' => '',
            'mp3PromoImage3' => '',
            'mp3PromoImage4' => '',
            'mp3PromoImage5' => '',
            'mp3PromoDesc' => 'Yt1s Easy YouTube to MP3 tool that helps you convert YouTube to mp3 Free, Fast, and completely Secure. using this Youtube Converter tool convert and download youtube to mp3 in High Quality such as 320kbps, 256kbps, 192kbps, 128kbps, 64kbps.',
        ...
        $mpFields = array_merge($navFields, $imageFields, [
            ...
            'heroSubtitle' => ['group' => 'Hero', 'label' => 'Hero Subtitle', 'type' => 'textarea', 'render' => 'text', 'selector' => '.hero-subtitle', 'allow_html' => true],
            ...
            'sectionTitle' => ['group' => 'Intro', 'label' => 'Intro Section Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.description-section .section-title', 'allow_html' => true],
            ...
            'feature1Title' => ['group' => 'Features', 'label' => 'Feature 1 Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(1) .feature-title', 'allow_html' => true],
            ...
            'feature2Title' => ['group' => 'Features', 'label' => 'Feature 2 Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(2) .feature-title', 'allow_html' => true],
            ...
            'feature3Title' => ['group' => 'Features', 'label' => 'Feature 3 Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(3) .feature-title', 'allow_html' => true],
            ...
            'feature4Title' => ['group' => 'Features', 'label' => 'Feature 4 Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(4) .feature-title', 'allow_html' => true],
            'feature4Desc' => ['group' => 'Features', 'label' => 'Feature 4 Description', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(4) .feature-description', 'allow_html' => true],
            'feature5Title' => ['group' => 'Features', 'label' => 'Feature 5 Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(5) .feature-title', 'allow_html' => true],
            'feature5Desc' => ['group' => 'Features', 'label' => 'Feature 5 Description', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(5) .feature-description', 'allow_html' => true],
            'feature6Title' => ['group' => 'Features', 'label' => 'Feature 6 Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(6) .feature-title', 'allow_html' => true],
            'feature6Desc' => ['group' => 'Features', 'label' => 'Feature 6 Description', 'type' => 'textarea', 'render' => 'html', 'selector' => '.features-section .feature-card:nth-of-type(6) .feature-description', 'allow_html' => true],
            'mp3PromoTitle' => ['group' => 'MP3 Promo', 'label' => 'Promo Heading', 'type' => 'textarea', 'render' => 'html', 'selector' => '.mp3-promo-title', 'allow_html' => true],
            'mp3PromoDesc' => ['group' => 'MP3 Promo', 'label' => 'Promo Description', 'type' => 'textarea', 'render' => 'html', 'selector' => '.mp3-promo-description p', 'allow_html' => true],
            'mp3PromoImage1' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 1', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(1) img', 'attribute' => 'src'],
            'mp3PromoImage2' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 2', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(2) img', 'attribute' => 'src'],
            'mp3PromoImage3' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 3', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(3) img', 'attribute' => 'src'],
            'mp3PromoImage4' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 4', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(4) img', 'attribute' => 'src'],
            'mp3PromoImage5' => ['group' => 'MP3 Promo', 'label' => 'Promo Image 5', 'type' => 'image', 'render' => 'src', 'selector' => '.mp3-promo-grid .promo-item:nth-of-type(5) img', 'attribute' => 'src'],
            'formatsTitle' => ['group' => 'Formats', 'label' => 'Formats Section Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.formats-section .section-title', 'allow_html' => true],
            ...
            'stepsTitle' => ['group' => 'Steps', 'label' => 'Steps Title', 'type' => 'textarea', 'render' => 'html', 'selector' => '.steps-section .section-title', 'allow_html' => true],
            'step1' => ['group' => 'Steps', 'label' => 'Step 1', 'type' => 'textarea', 'render' => 'html', 'selector' => '.steps-section .step-item:nth-of-type(1) .step-text', 'allow_html' => true],
            'step2' => ['group' => 'Steps', 'label' => 'Step 2', 'type' => 'textarea', 'render' => 'html', 'selector' => '.steps-section .step-item:nth-of-type(2) .step-text', 'allow_html' => true],
            'step3' => ['group' => 'Steps', 'label' => 'Step 3', 'type' => 'textarea', 'render' => 'html', 'selector' => '.steps-section .step-item:nth-of-type(3) .step-text', 'allow_html' => true],
            'faqTitle' => ['group' => 'FAQ', 'label' => 'FAQ Title', 'type' => 'textarea', 'render' => 'html', 'allow_html' => true],
        ...
        $mp4Defaults = [
            ...
            'feature6Title' => 'Cloud integration',
            'feature6Desc' => 'We offer to upload and save converted files directly into Google Drive and Dropbox.',
            'mp3PromoTitle' => 'Free Online YouTube to MP4 converter',
            'mp3PromoImage1' => '',
            'mp3PromoImage2' => '',
            'mp3PromoImage3' => '',
            'mp3PromoImage4' => '',
            'mp3PromoImage5' => '',
            'mp3PromoDesc' => 'Yt1s Easy YouTube to MP4 tool that helps you convert YouTube to mp4 Free, Fast, and completely Secure. using this Youtube Converter tool convert and download youtube to mp4 in High Quality such as 1080p, 720p, 480p, 360p, 240p, 144p.',
