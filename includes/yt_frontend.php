...
if (!function_exists('yt_frontend_registry')) {
    function yt_frontend_registry(): array
    {
        ...
        $homeFields = array_merge($navFields, [
        ...
        $homeDefaults = [
            ...
            'feature1Title' => 'Easy to use and Fast',
            'feature1Desc' => 'Copy, paste, convert. No installation needed.',
            'feature2Title' => 'Unlimited Conversions',
            'feature2Desc' => 'Download as many MP3 or MP4 files as you want.',
            'feature3Title' => 'Safe and Secure',
            'feature3Desc' => 'We never store personal data and keep the tool malware-free.',
        ...
        $mpFields = array_merge($navFields, [
            'meta_title' => ['group' => 'Meta', 'label' => 'Meta Title', 'type' => 'text', 'render' => 'meta_title'],
            'meta_description' => ['group' => 'Meta', 'label' => 'Meta Description', 'type' => 'textarea', 'render' => 'meta_description'],
